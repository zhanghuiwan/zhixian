...
当前界面以 AI 对话为主页，一级导航收敛为“AI 对话、学习、记录”三项；单词学习、词书、连续阅读、句子收藏和我的新增单词统一进入学习中心。对话历史默认收起，同一用户每天默认续接一个会话，手动点击“新对话”才创建独立会话；Agent 仍可按需检索当前用户的全部持久化会话。全局词典统一去重，四级、六级、考研通用、考研英语一/二和雅思作为六本独立系统预设词书展示；用户也可以创建自己的词书，并让 AI 在确认后补充仅自己可见的新词。

## 第一阶段已包含

- 用户注册、登录、资料与每日学习节奏设置
- 内置词书、词书选择和学习进度
- 三档熟悉度、0–100 滑杆、分轮巩固和快速复习模式
- 自定义生词本、熟练度和来源记录
- 英文文章列表、逐句阅读、单词释义
- 单句翻译、句子收藏、文章生词入本
- 学习仪表盘、连续学习天数和基础统计
...
- 结构化例句、文章草稿和明确授权的长期学习偏好
- 跨会话关键词检索，以及“词库未收录 → 用户确认 → AI 补词”的私有词条流程
- AI 回答安全 Markdown 渲染、默认当日会话和短生命周期查询状态
- 按输入类型生成的上下文操作：单词加入词本、句子收藏、长文保存阅读、计划开始学习
- 查词固定覆盖中英释义、音标、分义项语境、词形语法、常见用法、例句和易混词；翻译固定区分规范译文、语义、表达、语法与语境

## AI 学习工作台已包含

- AI 对话独占主页；学习中心聚合单词、阅读、句子与词库，记录保持独立入口
- 六本独立系统预设词书，以及可创建、选中和维护的个人词书
- 按词书分别学习新词或复习到期词；整组完成后批量入库并记录组内错误次数
- 系统词与“我的新增”词统一进入生词本和学习队列，并在界面明确标记来源
