...
当前界面以 AI 对话为主页，并把词书、连续阅读、句子收藏和学习日历组织成五个稳定入口。对话历史默认收起，但 Agent 可按需检索当前用户的全部持久化会话。全局词典统一去重，四级、六级、考研通用、考研英语一/二和雅思作为六本独立系统预设词书展示；用户也可以创建自己的词书，并让 AI 在确认后补充仅自己可见的新词。
...
- AI 首页、桌面/移动端对话界面、默认收起的历史会话和短生命周期查询状态
